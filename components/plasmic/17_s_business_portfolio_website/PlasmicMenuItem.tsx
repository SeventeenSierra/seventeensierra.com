...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: hq-LirU1Now3/css
    ...
    >
        ...
        {renderPlasmicSlot({
          defaultContents: (
            <FaCircleDotRegularsvgIcon
              className={classNames(projectcss.all, sty.svg__auUn)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <FaCircleDotRegularsvgIcon
              className={classNames(projectcss.all, sty.svg__nJDv)}
              role={"img"}
            />
          ),
